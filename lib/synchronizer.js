...
let {Downloader, Downloadable, MILLIS_IN_SECOND, MILLIS_IN_MINUTE, MILLIS_IN_HOUR, MILLIS_IN_DAY} = require("downloader");
...
let Synchronizer = exports.Synchronizer =
{
  ...
  {
    downloader.download(this.getDownloadable(subscription, manual));
  },
  ...
  getDownloadables: function()
  {
    ...
    for each (let subscription in FilterStorage.subscriptions)
    {
      if (subscription instanceof DownloadableSubscription)
        yield this.getDownloadable(subscription, false);
    }
  },
   ...
   */
  getDownloadable: function(/**Subscription*/ subscription, /**Boolean*/ manual) /**Downloadable*/
  {
