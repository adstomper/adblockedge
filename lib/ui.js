...
let optionsObserver =
{
  ...
  initOptionsDoc: function(/**Document*/ doc)
  {
    ...
    hideElement("adblockedge-showinaddonbar", !hasAddonBar);
    ...
    function initCheckboxes()
    {
      ...
      if (window)
      {
        setChecked("adblockedge-showinaddonbar", UI.isToolbarIconVisible(window));
        ...
        addCommandHandler("adblockedge-showinaddonbar", handler);
        addCommandHandler("adblockedge-showintoolbar", handler);
      }
  ...
  openReportDialog: function(/**Window*/ window)
  {
    ...
    else
    {
      ...
      if (uri)
      {
        ...
        window.openDialog("chrome://adblockedge/content/ui/sendReport.xul", "_blank", "chrome,centerscreen,resizable=no", getBrowser(window).contentWindow, uri);
      }
    }
  },
